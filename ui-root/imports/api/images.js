/**
 * All functionality regarding handling & storage of images
 */
...
function handleImageAfterUpload(image) {
    // Move file to GridFS
...
function handleImageInterceptDownload(http, image, versionName) {
...
function handleImageOnAfterRemove(images) {
...
export const Images = new FilesCollection({
    ...
    onBeforeUpload:     handleImageBeforeUpload,
    onAfterUpload:      handleImageAfterUpload,
    interceptDownload:  handleImageInterceptDownload,
    onAfterRemove:      handleImageOnAfterRemove,
});
